      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark bg-success fixed-top">
          <div className="container">
            <img
              src="./src/assets/BTS_Images/dognose.webp"
              width="30"
              height="24"
              alt="Logo"
            />
              ...
              <ul className="navbar-nav ml-auto">
                <li className="nav-item">
                  <div className="d-flex flex-column align-items-center">
                    <img
                      src="./src/assets/BTS_Images/doghouse.webp"
                      width="30"
                      height="24"
                      alt="Icon"
                    />
                ...
                <li className="nav-item">
                  <div className="d-flex flex-column align-items-center">
                    <img
                      src="./src/assets/BTS_Images/dogbook.webp"
                      width="30"
                      height="24"
                      alt="Icon"
                    />
                ...
                <li className="nav-item">
                  <div className="d-flex flex-column align-items-center">
                    <img
                      src="./src/assets/BTS_Images/dogwalk.webp"
                      width="30"
                      height="24"
                      alt="Icon"
                    />
